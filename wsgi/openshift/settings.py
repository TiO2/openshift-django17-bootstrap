...
if ON_OPENSHIFT:
    ...
    SECRET_KEY = 'AaBbCcDdEeFfGgKhIiJjKkLlMmN*GoPpQqRrSsTtUuVvWwXxYyZz' # dev key
...
if ON_OPENSHIFT:
    ...
    STATICFILES_DIRS = (os.path.join(BASE_DIR, 'static'),) # If omitted, local static files serving may not work
STATIC_URL = '/static/'
